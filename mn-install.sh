...
COIN_TGZ='https://github.com/altbet/abet/releases/download/v.2.0.0.2/altbet-v2.0.0.2-ubu1604.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='altbet'
COIN_PORT=2238
RPC_PORT=2239
COIN_BLOCKS='https://github.com/altbet/bootstraps/releases/download/305916/bootstrap.zip'
...
addnode=188.40.182.64:2238
addnode=95.217.54.157:2238
addnode=136.243.63.208:2238
addnode=188.213.166.16:2238
EOF
}
